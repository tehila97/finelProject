    ...
    <div className='square middle'>
        ...
        {user.isEditing ? (
          ...
          {academicProfession.map ((proffesion, index) => (
            <option key={index} value={proffesion}>{proffesion}</option>
          ))} </select> ) : (
        ...
        {user.isEditing ? (
          ...
          {AcademicInstitution.map ((academicInstitution, index) => (
            <option key={index} value={academicInstitution}>{academicInstitution}</option>
          ))} </select> ) : (
        ...
        {user.isEditing ? (
          ...
          {TypeOfService.map ((typeOfService, index) => (
            <option key={index} value={typeOfService}>{typeOfService}</option>
          ))} </select> ) : (
